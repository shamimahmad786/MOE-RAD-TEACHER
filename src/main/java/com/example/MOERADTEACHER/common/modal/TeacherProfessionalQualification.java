...
//
//@Entity
//@Table(name = "teacher_professional_qualification_detail",schema="public")
//public class TeacherProfessionalQualification implements Serializable{
//	
////	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "teacher_professional_qualification_id_seq")
//	
////	@GeneratedValue(strategy = GenerationType.AUTO, generator = "teacher_professional_qualification_id_seq")
////	@SequenceGenerator(name = "teacher_professional_qualification_id_seq", sequenceName = "teacher_professional_qualification_id_seq")
//	@Id
//	@Column(name = "teacher_professional_qualification_id")
//	private Integer teacherProfessionalQualificationId;
...
//	
//	
//	public Integer getTeacherProfessionalQualificationId() {
//		return teacherProfessionalQualificationId;
//	}
//	public void setTeacherProfessionalQualificationId(Integer teacherProfessionalQualificationId) {
//		this.teacherProfessionalQualificationId = teacherProfessionalQualificationId;
//	}
